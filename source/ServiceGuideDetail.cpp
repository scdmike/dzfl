...
//utf-8
void ServiceGuideDetail::Show(Record& vdata)
{
...
void ServiceGuideDetail::showMobileInput() {
...
void ServiceGuideDetail::sendMessage() {
...
void ServiceGuideDetail::dragMove(int x, int y)
{
...
void ServiceGuideDetail::btnClick(int index)
{
    UIItem("sendMessage")->setVisible(false);
    ...
    case 0:
    {
        text = (const char*)guideContent["approvalBasedOn"];
        selectButton = "【法律依据】";
    ...
    case 1:
        text = (const char*)guideContent["approvalCondition"];
        selectButton = "【办理条件】";
        break;
    case 2:
        text = (const char*)guideContent["approvalInformation"];
        selectButton = "【申报材料】";
        break;
    case 3:
    ...
    case 5:
        ...
        break;
    case 6:
        text = (const char*)guideContent["chargesBased"];
        selectButton = "【收费依据】";
    }
    char buf[16];
    for (int i = 0; i < 6; i++) {
    ...
    QString name = QString(guideContent["applyname"]).replace("<BR>", "\n");
    if (name.length() > 46)
        name = name.left(43) + "...";
    ...
    UIItem("tbContent")->setProperty("text", text.replace("<BR>", "\n"));
